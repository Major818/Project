		...
		<div class="container">	
			<div class="page-heading">	
				<div class="page-main-title">
					...
					<h2>预约 <span>体验</span></h2>
				</div>
				<h5>预约维修改造 | 预约保养美容 | 预约驾车体验 |联系我们</h5>
			</div> <!-- /.page-heading -->
		</div> <!-- /.container -->
	</section> <!-- /.properties -->
	<!-- /PROPERTIES AREA END -->
						...
						<div class="col-xs-12 col-sm-12 col-md-10 col-lg-8 col-xs-offset-0 col-sm-offset-0 col-md-offset-1 col-lg-offset-2">
							...
							<div class="row">
								<div class="contact-form">
									<form method="post" action="/index2" id="signupForm">
										<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
											<div class="form-group">
												<div class="input-img">
													<input type="text" name="dateName" class="form-control" id="firstname" required placeholder="姓名">
										...
										<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
											<div class="form-group">
												<div class="input-img">
													<input type="tel" name="telephone" class="form-control" placeholder="电话">
													<div class="input-icon">
														<i class="fa fa-phone"></i>
													</div>
												</div>
											...
											<div class="form-group">
												<div class="input-img">
													<!--<input type="url" name="Website" class="form-control" placeholder="Website (optional)">-->
														<select id="province" name="server" onchange="selectCity(this)" style="border: none;border-bottom:1px solid #b7b7b7;height:45px;font-size: 16px;width:100%; appearance:none;-moz-appearance:none;  -webkit-appearance:none; color:#b7b7b7;" >
															<option>--选择预约服务--</option>
															<option value="汽车维修">汽车维修</option>
															<option value="汽车改造">汽车改造</option>
															<option value="汽车保养">汽车保养</option>
															<option value="汽车美容">汽车美容</option>
															<option value="驾驶体验">驾驶体验</option>
										...
										<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
											<div class="form-group">
												<div class="text-area">
													<textarea name="remark" class="form-control" placeholder="建议/备注信息/其他"></textarea>
												</div>
											</div>
										</div> <!-- /.col- -->
										<div class="form-group col-xs-12 col-md-12 col-lg-12">
											<div class="form-btn">
												<button type="submit" name="submit" class="contact-form-btn gen-btn">提交</button>
											</div>
										</div>
