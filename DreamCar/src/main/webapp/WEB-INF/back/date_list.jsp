	...
	<script type="text/javascript">
		$(function() {
			...
			$(".del").click(function() {
				...
				//获取所要删除商品 的ID
				var pid = $(this).parents("tr").find(".name").attr("id");
				var _this = this;
...
-->
										...
										<c:forEach items="${reservationList}" var="re">
											...
											<tr>
												<td class="center"  style="line-height:5;">
													<label>
														<input type="checkbox" class="ace" />
														<span class="lbl"></span>
													</label>
												...
												<td style="line-height:5;">${re.dateId}</td>
												<td style="line-height:5;" class="name" id="${re.dateName}">${re.dateName}</td>
												<td style="line-height:5;">${re.email}</td>
												<td style="line-height:5;">${re.telephone}</td>
												<td style="line-height:5;">${re.server}</td>
												<td style="line-height:5;">${re.remark}</td>


												<!--<td class="hidden-480"  style="line-height:10;">${prod.prodName}</td>
														<td style="line-height:10;">￥${prod.prodPrice}</td>
														<td  style="line-height:10;">
															<input type="text" class="pnum" id="${ prod.prodId }"
