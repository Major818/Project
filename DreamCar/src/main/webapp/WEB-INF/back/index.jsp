...
<![endif]-->
		...
		<script src="back/assets/js/jquery-ui-1.10.3.custom.min.js"></script>
		<script src="back/assets/js/jquery.ui.touch-punch.min.js"></script>
		<script src="back/assets/js/jquery.slimscroll.min.js"></script>
		<script src="back/assets/js/jquery.easy-pie-chart.min.js"></script>
		<script src="back/assets/js/jquery.sparkline.min.js"></script>
		<script src="back/assets/js/flot/jquery.flot.min.js"></script>
		<script src="back/assets/js/flot/jquery.flot.pie.min.js"></script>
		<script src="back/assets/js/flot/jquery.flot.resize.min.js"></script>
		...
		<script type="text/javascript">
			jQuery(function($) {
			  ...
			  var data = [
				{ label: "宝马",  data: 38.7, color: "#68BC31"},
				{ label: "奥迪",  data: 24.5, color: "#2091CF"},
				{ label: "奇瑞",  data: 8.2, color: "#AF4E96"},
				{ label: "劳斯莱斯",  data: 18.6, color: "#DA5430"},
