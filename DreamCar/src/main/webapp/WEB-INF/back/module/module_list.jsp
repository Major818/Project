											...
											<%--<div class="widget-body">
												...
												<table id="sample-table-1" class="table table-striped table-bordered table-hover" >
													...
													<tr>
														<th class="center">
															<label>
																<input type="checkbox" class="ace" onclick="checkAll('moduleId',this)" name="selid"/>
																<span class="lbl"></span>
															</label>
														</th>
														<th>序号</th>
													...
													<c:forEach items="${moduleList}" var="m" varStatus="s">
														<tr>
															<td class="center" >
																...
																<input type="checkbox" class="ace" value="${m.moduleId}" name="moduleId"/>
																<span class="lbl"></span>
															...
															<td>
																<div class="visible-md visible-lg hidden-sm hidden-xs btn-group" >
																	<a  class="btn btn-xs btn-success" href="#"   onclick="formSubmit('toModuleCreate','_self'),this.blur();">
																		<i class="icon-ok bigger-120"></i>
																	</a>
																	<a  class="btn btn-xs btn-info" href="#"  onclick="formSubmit('toModuleUpdate','_self'),this.blur();">
																		<i class="icon-edit bigger-120"></i>
																	</a>

																	<a  class="btn btn-xs btn-danger" href="#"  onclick="formSubmit('toModuleDelete','_self'),this.blur();">
																		<i class="icon-trash bigger-120"></i>
																	</a>

																	<a  class="btn btn-xs btn-warning"  href="#" onclick="formSubmit('toModuleView','_self'),this.blur();">
