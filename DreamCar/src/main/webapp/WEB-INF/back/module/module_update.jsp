										...
										<div class="table-responsive">
											...
											<%--<div class="widget-body">
												...
												<table id="sample-table-1" class="table table-striped table-bordered table-hover" >
													<tr>
														<input type="text" hidden="hidden" value="${module.moduleId}" name="moduleId">
													</tr>
													<tr>
														<td>权限名称</td>
														<td>
															<input name="name" type="text" value="${module.name}"/>
														</td>
													</tr>
													<tr>
														<td>权限级别</td>
														<td>
															<select name="ctype" style="width:121px">
																<option value="1" <c:if test="${module.ctype==1}">selected="selected"</c:if>>后台</option>
													...
													<tr>
														<td>权限备注</td>
														<td>
															<input name="remark" type="text" value="${module.remark}"/>
														</td>
													</tr>
													<td>
														<div class="visible-md visible-lg hidden-sm hidden-xs btn-group" >
															<a  class="btn btn-xs btn-success" href="#" onclick="formSubmit('toModuleUpdate2','_self') ,this.blur();">
