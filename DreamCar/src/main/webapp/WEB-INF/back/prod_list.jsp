...
<style>
	td{text-align: center;}
												...
												<tbody>
													...
													<tr>
														<td class="center"  style="line-height:10;">
															<label>
																<input type="checkbox" class="ace" />
																<span class="lbl"></span>
															</label>
														...
														<td style="text-align: center;"  style="line-height:10;"><img img width="160px" height="120px"alt="150x150" src="${prod.prodImgurl}" />
														</td>
														<td style="line-height:10;">${prod.prodId}</td>
