												...
												<table id="sample-table-1" class="table table-striped table-bordered table-hover" >
													<thead>
														<tr>
															<th class="center">
																<label>
																	<input type="checkbox" class="ace" onclick="checkAll('roleId',this)" name="selid"/>
																	<span class="lbl"></span>
																</label>
															</th>
															<th>序号</th>
													...
													<c:forEach items="${roleList}" var="r" varStatus="s">
														<tr>
															<td class="center" >
																	...
																	<input type="checkbox" class="ace" value="${r.roleId}" name="roleId"/>
																	<span class="lbl"></span>
															...
															<td>
																<fmt:formatDate value="${r.updateTime}" pattern="yyyy-MM-dd"/>
															</td>
															<td>
																<div class="visible-md visible-lg hidden-sm hidden-xs btn-group" >
																	<a  class="btn btn-xs btn-success" href="#"   onclick="formSubmit('toRoleCreate','_self'),this.blur();">
																		<i class="icon-ok bigger-120"></i>
																	</a>
																	<a  class="btn btn-xs btn-info" href="#"  onclick="formSubmit('toRoleUpdate','_self'),this.blur();">
																		<i class="icon-edit bigger-120"></i>
																	</a>

																	<a  class="btn btn-xs btn-danger" href="#"  onclick="formSubmit('toRoleDelete','_self'),this.blur();">
																		<i class="icon-trash bigger-120"></i>
																	</a>

																	<a  class="btn btn-xs btn-warning"  href="#" onclick="formSubmit('toRoleView','_self'),this.blur();">
																		<i class="icon-folder-open bigger-120"></i>
																	</a>
																	<a  class="btn btn-xs btn-warning"  href="#" onclick="formSubmit('toRoleModule','_self'),this.blur();">权限
