                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="row">
                                <table id="ec_table" class="tableRegion" width="98%" >
                                    ...
                                    <%--<td>
                                        <select name="role.roleId" style="width:121px">
                                            <option value="">---请选择---</option>
                                    ...
                                    <tr class="odd">
                                        ...
                                        <td>汽车品牌：</td>
                                        <td><input name="car.carName" type="text"/></td>
                                    </tr>
                                    <tr class="odd">
                                        <td>汽车型号：</td>
                                        <td><input name="car.carNum" type="text"/></td>
                                        <td>汽车颜色：</td>
                                        <td><input name="car.carColor" type="text"/></td>
                                    <tr class="odd">
                                    ...
                                    <td>
                                        <div class="visible-md visible-lg hidden-sm hidden-xs btn-group" >
                                            <a  class="btn btn-xs btn-success" href="#" onclick="formSubmit('toUserCreate2','_self') ,this.blur();">
