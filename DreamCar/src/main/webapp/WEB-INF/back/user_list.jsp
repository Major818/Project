											...
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												...
												<c:forEach items="${userList}" var="u" varStatus="status">
													<tr>
														<td class="center">
															<label>
																<input type="checkbox" name="userId" value="${u.userId}"/>
																<span class="lbl"></span>
															</label>
														</td>
														...
														<td>${u.car.carName}</td>
														<td>${u.car.carNum}</td>
														<td>${u.car.carColor}</td>
														<td>${u.role.name}</td>
														<td>

															<div class="visible-md visible-lg hidden-sm hidden-xs btn-group" >
																<a  class="btn btn-xs btn-success" href="#"   onclick="formSubmit('toUserCreate','_self'),this.blur();">
																...
																<a  class="btn btn-xs btn-danger" href="#"  onclick="formSubmit('toUserDelete','_self'),this.blur();">
