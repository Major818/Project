									...
									<form method="post" action="/login" id="signupForm">
										<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
											<div class="form-group">
												<div class="input-img">
													<input type="text" name="username" class="form-control" value="${ cookie.remname.value }" required placeholder="姓名">
									...
									<%--	<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
											<div class="form-group">
												<div class="checkbox" style="text-align: center;">
													<label>
														<input type="checkbox" name="remname" value="true" style="height:10px" ${ empty cookie.remname ? "" : "checked='checked'" }> 记住用户名
													</label>
												</div>
											</div>
										</div> <!-- /.col- -->
										<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
											<div class="form-group">
												<div class="checkbox"  style="text-align: center;">
													<label>
														<input type="checkbox" name="rememberMe" value="true"  style="height:10px;"> 30天自动登录
													</label>
												</div>
											</div>
										</div>--%>
										...
										<div class="form-group col-xs-12 col-md-12 col-lg-12">
											<div class="form-btn" style="text-align:center">
												<button type="submit" name="submit" class="contact-form-btn gen-btn">登录</button>
